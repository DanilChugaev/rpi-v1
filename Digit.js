...
module.exports = class Digit {
     ...
     */
    zero({ x = 0, y = 0 } = {}) {
        this.pixels[this.index({ x: x + 0, y: y + 0 })] = this.color;
        this.pixels[this.index({ x: x + 1, y: y + 0 })] = this.color;
        this.pixels[this.index({ x: x + 2, y: y + 0 })] = this.color;

        this.pixels[this.index({ x: x + 0, y: y + 1 })] = this.color;
        this.pixels[this.index({ x: x + 2, y: y + 1 })] = this.color;

        this.pixels[this.index({ x: x + 0, y: y + 2 })] = this.color;
        this.pixels[this.index({ x: x + 2, y: y + 2 })] = this.color;

        this.pixels[this.index({ x: x + 0, y: y + 3 })] = this.color;
        this.pixels[this.index({ x: x + 2, y: y + 3 })] = this.color;

        this.pixels[this.index({ x: x + 0, y: y + 4 })] = this.color;
